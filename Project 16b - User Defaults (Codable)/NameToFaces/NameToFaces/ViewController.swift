...
class ViewController: UICollectionViewController {
  ...
  override func viewDidLoad() {
    ...
    if let savedPeople = defaults.object(forKey: "people") as? Data {
      // decode the data to Person array and asign it to people
  ...
  // 1* a method that will save the people array in form of Data in UserDefaults
  func save() {
