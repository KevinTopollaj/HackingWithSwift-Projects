...
//
import WatchConnectivity    /// will suport communication with watch os
import AVFoundation
import UIKit
...
class ViewController: UIViewController, WCSessionDelegate {
  ...
  // a property that holds our music audio
  var music: AVAudioPlayer!
  // will check when the last message was set to the watch
  ...
  @objc func loadCards() {
    ...
    // enable the user interaction with the cards
    view.isUserInteractionEnabled = true

  }
  
  func cardTapped(_ tapped: CardViewController) {
    //  the first two lines stop users tapping two cards at once.
  ...
  // a method that will play the music
  func playMusic() {
  ...
  // a system method that locates where the user has touch on the screen
  ...
  /// Methods required to conform to the delegate
